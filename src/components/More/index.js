  ...
  return (
    <div className="detail__container">
      ...
      <p>
        ...
        <strong> organizadora</strong>, a potenciar mi{" "}
        <strong>trabajo en grupo</strong> y a saber <strong> adaptarme</strong>{" "}
        a cualquier situación.
      </p>
      <p>
        Sé que la derrota es un método más de aprendizaje y la victoria una
        recompensa al esfuerzo. Considero fundamental la{" "}
        <strong>autocrítica</strong> para poder avanzar en cualquier ámbito: una
        debe suplir sus posibles carencias enfrentándose a ellas y, por extraño
        que parezca, aquello a lo que temíamos se puede convertir en nuestro
        mejor aliado.
      </p>
      <h2 className="experience__title">
        Las tecnologías que más me interesan
      </h2>
      <p>
        Me he formado como Front-End, pero también quiero explorar otros
        lenguajes de programación y poder descubrir el mundo del Back-End.
      </p>
